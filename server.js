...
const stripe = require('stripe')('sk_test_51OCjmQEnnlTCDnlQHJqXqcrcsZhBAGQf1OTy2S0hg5LLLoVy1evnXTMUEmCZ6OGm4O3JRoA8WCPDSSRGpxZyuvsw00KqXboqUx');
const app = express();
...
.from('Payment_info')
.insert([
  { donation_id: custom_fields,client:clientReferenceId, amount: amount },
])
.select()
